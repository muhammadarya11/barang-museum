...
<?php $__env->startSection('title', 'Tentang Museum'); ?>
<?php $__env->startSection('body_class', 'halaman-bergambar'); ?>

<?php $__env->startSection('konten'); ?>
<div class="about-wrapper" style="background: url('<?php echo e(asset('images/museum-profil.jpg')); ?>') no-repeat center center fixed; background-size: cover; min-height: 100vh; padding: 60px 15px; display: flex; justify-content: center; align-items: center;">
    <div class="bg-glass">
...
<?php echo $__env->make('layout.app_pengunjung', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\barang-museum2\barang-museum\resources\views/pengunjung/about.blade.php ENDPATH**/ ?>