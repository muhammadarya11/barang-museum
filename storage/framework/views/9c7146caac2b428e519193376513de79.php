...
<?php $__env->startSection('title', 'Koleksi Pengunjung'); ?>
...
<div class="header-koleksi">
    ...
    <form action="<?php echo e(route('koleksi.pengunjung')); ?>" method="GET" class="search-box">
        <button type="submit"><i class="fa fa-search"></i></button>
        <input type="text" name="cari" placeholder="Cari koleksi..." value="<?php echo e(request('cari')); ?>">
    </form>
</div>
...
<div class="table-responsive bg-white shadow-sm" style="max-width: 1000px; width: 95%; margin: 0 auto 60px auto; border-radius: 12px;">
    <table class="table table-bordered text-center mb-0">
        ...
        <tbody>
            <?php $__currentLoopData = $koleksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><img src="<?php echo e(asset('storage/' . $item->gambar)); ?>" alt="<?php echo e($item->nama_koleksi); ?>" class="koleksi-img"></td>
                    <td class="align-middle"><?php echo e($item->nama_koleksi); ?></td>
                    <td class="align-middle">
                        <button class="btn btn-sm btn-primary btn-detail"
                            data-bs-toggle="modal"
                            data-bs-target="#modalKoleksi"
                            data-nama="<?php echo e(e($item->nama_koleksi)); ?>"
                            data-asal="<?php echo e(e($item->asal_koleksi ?? '-')); ?>"
                            data-tahun="<?php echo e(e($item->tahun_perolehan ?? '-')); ?>"
                            data-kategori="<?php echo e(e($item->kategori ?? '-')); ?>"
                            data-deskripsi="<?php echo e(e($item->deskripsi ?? 'Deskripsi belum tersedia')); ?>"
...
<?php echo $__env->make('layout.app_pengunjung', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\barang-museum2\barang-museum\resources\views/pengunjung/koleksi_pengunjung.blade.php ENDPATH**/ ?>