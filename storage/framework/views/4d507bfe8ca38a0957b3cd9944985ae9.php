...
<?php $__env->startSection('title', 'Beranda Pengunjung'); ?>
...
<div class="container-fluid px-0">
    <div class="position-relative" style="height: 60vw; max-height: 480px; overflow: hidden;">
        <img src="<?php echo e(asset('images/dashboard.jpg')); ?>" 
                ...
                <div class="card w-100 border rounded text-center shadow-sm koleksi-card transition">
                    ...
                    <?php if($item['gambar']): ?>
                        <img src="<?php echo e(asset('storage/' . $item['gambar'])); ?>" 
                             alt="<?php echo e($item['nama_koleksi']); ?>" 
                    ...
                    <div class="card-body py-3">
                        <h6 class="fw-bold mb-2 text-dark"><?php echo e($item['nama_koleksi']); ?></h6>
                        <a href="<?php echo e(route('detail.koleksi', ['id' => $item['id_koleksi']])); ?>" 
        ...
        <div class="col-lg-12 col-md-12 mb-4">
            <div class="card shadow-sm flex-md-row flex-column align-items-center h-100 berita-card border rounded transition">
                ...
                <div class="card-body p-3">
                    <h5 class="card-title fw-bold mb-1 text-dark"><?php echo e($item['judul']); ?></h5>
                    <p class="text-muted small mb-1"><?php echo e($item['tanggal']); ?></p>
                    <p class="card-text small"><?php echo e(Str::limit($item['deskripsi'], 100)); ?></p>
                    <a href="<?php echo e($item['link']); ?>" target="_blank" class="btn btn-sm btn-outline-primary fw-semibold">
                        Baca Selengkapnya
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layout.app_pengunjung', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\barang-museum2\barang-museum\resources\views/pengunjung/dashboard_pengunjung.blade.php ENDPATH**/ ?>