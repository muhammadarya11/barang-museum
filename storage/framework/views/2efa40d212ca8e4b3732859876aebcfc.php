...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center mt-3">
          <small>Belum punya akun? <a href="<?php echo e(url('/register')); ?>">Daftar di sini</a></small>
        </div>
      </form>
    </div>
  </div>
...
<?php /**PATH C:\laragon\www\barang-museum2\barang-museum\resources\views/auth/login.blade.php ENDPATH**/ ?>